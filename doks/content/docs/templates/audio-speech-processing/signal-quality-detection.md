---
title: "信号质量监测 (Signal Quality Detection)"
description: "在波形播放器上听辨整条音频，按 1–10 星对「信号质量」主观打分；适合采集链路、编解码或录制质量的人审标量数据。"
lead: "Header 说明评分含义；Rating 与 Audio 绑定 toName=audio，整段一个分数，与 time-series 下「按区段打星」不同。"
...
params:
  seo:
      title: "信号质量监测 (Signal Quality Detection)"
      description: "在波形播放器上听辨整条音频，按 1–10 星对「信号质量」主观打分；适合采集链路、编解码或录制质量的人审标量数据。"
      keywords: ["标注模板", "信号质量", "Audio", "Rating", "音质", "MOS", "语音"]
      canonical: "https://docs.jujidata.com/docs/templates/audio-speech-processing/signal-quality-detection"
      robots: "index, follow"
---
