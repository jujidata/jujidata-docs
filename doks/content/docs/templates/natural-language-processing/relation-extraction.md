...
description: "关系抽取标注模版，支持在文本中标注实体跨度并以关系边连接实体对，适配共指消解、事件关系与结构化知识抽取等 NLP 任务。"
lead: "关系抽取在实体标注的基础上，用有向关系将两个实体（或短语）关联起来，形成「头实体—关系类型—尾实体」式监督数据，常用于知识图谱、事件抽取与共指链构建。"
...
params:
  seo:
      title: "关系抽取 (Relation Extraction)"
      description: "关系抽取标注模版，支持在文本中标注实体跨度并以关系边连接实体对，适配共指消解、事件关系与结构化知识抽取等 NLP 任务。"
      keywords: ["标注模板", "关系抽取", "Relation Extraction", "共指", "实体关系"]
      canonical: "https://docs.jujidata.com/docs/templates/natural-language-processing/relation-extraction"
      robots: "index, follow"
---
