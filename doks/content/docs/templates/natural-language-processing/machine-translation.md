...
description: "机器翻译标注模版，支持阅读源语言文本并录入目标语言译文，适配翻译数据构建、术语对齐与多语种模型训练场景。"
lead: "机器翻译标注通过“源文本 + 目标文本”配对形成高质量平行语料，是训练与评估翻译模型、优化术语一致性和提升多语种理解能力的基础数据来源。"
...
params:
  seo:
      title: "机器翻译 (Machine Translation)"
      description: "机器翻译标注模版，支持阅读源语言文本并录入目标语言译文，适配翻译数据构建、术语对齐与多语种模型训练场景。"
      keywords: ["标注模板", "机器翻译", "Machine Translation", "平行语料"]
      canonical: "https://docs.jujidata.com/docs/templates/natural-language-processing/machine-translation"
      robots: "index, follow"
---
