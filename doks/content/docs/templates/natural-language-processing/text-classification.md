...
description: "文本分类标注模版，支持展示待分类文本并以单选方式选择类别，适配情感分析、主题分类、意图识别等 NLP 任务。"
lead: "文本分类是 NLP 中最常见的监督形式之一：给定一段文本，标注人员从预设类别中选出最符合的一项，形成可用于文本分类与情感分析模型训练的结构化标签。"
...
params:
  seo:
      title: "文本分类 (Text Classification)"
      description: "文本分类标注模版，支持展示待分类文本并以单选方式选择类别，适配情感分析、主题分类、意图识别等 NLP 任务。"
      keywords: ["标注模板", "文本分类", "情感分析", "Text Classification"]
      canonical: "https://docs.jujidata.com/docs/templates/natural-language-processing/text-classification"
      robots: "index, follow"
---
