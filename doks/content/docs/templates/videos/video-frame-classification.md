---
title: "视频帧分类 (Video Frame Classification)"
description: "视频帧分类标注模版，在时间轴上为片段标注动作、静止、慢动作等类别，适配时序行为与镜头节奏类任务。"
lead: "结合 TimelineLabels 与 Video，可在播放进度上拖拽或划定区段，为连续帧赋予随时间变化的类别标签。"
...
params:
  seo:
      title: "视频帧分类 (Video Frame Classification)"
      description: "视频帧分类标注模版，在时间轴上为片段标注动作、静止、慢动作等类别，适配时序行为与镜头节奏类任务。"
      keywords: ["标注模板", "视频帧分类", "TimelineLabels", "视频", "时序标注"]
      canonical: "https://docs.jujidata.com/docs/templates/videos/video-frame-classification"
      robots: "index, follow"
---
