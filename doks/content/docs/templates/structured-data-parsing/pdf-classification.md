---
title: "PDF 分类 (PDF Classification)"
description: "PDF 分类标注模版，在阅读器中展示文档，上方提供星级评分与单选类别，适配长文质量、体裁与用途等人工判别。"
lead: "将版式固定的 PDF 与分类、评分控件同屏呈现，标注员可先阅读全文并选定文章类型，再给出星级评分，便于构建文档理解与人审数据集。"
...
params:
  seo:
      title: "PDF 分类 (PDF Classification)"
      description: "PDF 分类标注模版，在阅读器中展示文档，上方提供星级评分与单选类别，适配长文质量、体裁与用途等人工判别。"
      keywords: ["标注模板", "PDF 分类", "PDF Classification", "结构化数据", "文档理解"]
      canonical: "https://docs.jujidata.com/docs/templates/structured-data-parsing/pdf-classification"
      robots: "index, follow"
---
