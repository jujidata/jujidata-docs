...
params:
  seo:
      ...
      canonical: "https://docs.jujidata.com/docs/templates/computer-vision/semantic-segmentation-with-masks"
      robots: "index, follow"
---

# 带掩码的语义分割使用说明

带掩码的语义分割可以理解为“像涂色一样去标注”：选择对应类别的画笔，在目标区域上涂抹，让掩码按像素把目标覆盖出来，从而得到更精细的分割标注。它适合边缘不太清晰、形状不规则，或需要保留细节纹理的目标，比如飞机、云朵、植被、医学影像病灶等，广泛应用于航空航天影像分析、遥感图像识别、医疗影像诊断等领域。
