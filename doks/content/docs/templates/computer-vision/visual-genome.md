---
title: "视觉基因组 (Visual Genome)"
description: "视觉基因组标注模版，支持区域、属性、关系三类标签分栏标注，适配图像语义理解与场景关系建模任务。"
lead: "视觉基因组标注用于构建更丰富的图像语义数据，不仅标注区域目标，还可同步描述目标属性与目标间关系，适用于场景理解、图文推理与多模态模型训练。"
...
params:
  seo:
      title: "视觉基因组 (Visual Genome)"
      description: "视觉基因组标注模版，支持区域、属性、关系三类标签分栏标注，适配图像语义理解与场景关系建模任务。"
      keywords: ["标注模板", "视觉基因组", "Visual Genome"]
      canonical: "https://docs.jujidata.com/docs/templates/computer-vision/visual-genome"
      robots: "index, follow"
---
