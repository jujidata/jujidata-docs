---
title: "意图分类和槽填充 (Intent Classification and Slot Filling)"
description: "意图分类与槽填充标注模版，支持在多轮人机对话中划选槽位实体，并对整段对话进行意图单选分类，适配任务型对话与客服机器人等场景。"
lead: "意图分类判断「整段对话在做什么」；槽填充在轮次文本中标出结构化字段（人物、地点、数量等）。本模版将段落对话、槽位标签与意图选项组合在同一界面，便于一次性导出对话级标签与跨度级槽位。"
...
params:
  seo:
      title: "意图分类和槽填充 (Intent Classification and Slot Filling)"
      description: "意图分类与槽填充标注模版，支持在多轮人机对话中划选槽位实体，并对整段对话进行意图单选分类，适配任务型对话与客服机器人等场景。"
      keywords: ["标注模板", "意图分类", "槽填充", "Slot Filling", "对话式 AI", "Intent Classification"]
      canonical: "https://docs.jujidata.com/docs/templates/conversational-ai/intent-classification-and-slot-filling"
      robots: "index, follow"
---
