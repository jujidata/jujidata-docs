---
title: "响应选择 (Response Selection)"
description: "响应选择标注模版，在多轮人机对话下方展示候选回复，由标注员单选更合适的一条，适配对话排序、回复优选与偏好对齐等任务。"
lead: "给定对话上下文与若干候选系统回复，响应选择标注将「哪一条更合适」显式化，常用于训练与评测检索式对话、生成式对话的排序头或奖励模型。"
...
params:
  seo:
      title: "响应选择 (Response Selection)"
      description: "响应选择标注模版，在多轮人机对话下方展示候选回复，由标注员单选更合适的一条，适配对话排序、回复优选与偏好对齐等任务。"
      keywords: ["标注模板", "响应选择", "Response Selection", "对话式 AI", "对话排序"]
      canonical: "https://docs.jujidata.com/docs/templates/conversational-ai/response-selection"
      robots: "index, follow"
---
