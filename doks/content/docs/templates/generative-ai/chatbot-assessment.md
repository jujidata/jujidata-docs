---
title: "聊天机器人模型评估 (Chatbot Assessment)"
description: "聊天机器人模型评估模版，左侧多轮对话、右侧多维量表与合规项评测，适配对话质量、安全性与对齐类人工评估。"
lead: "在同屏展示完整会话与结构化问卷，将主观质量打分与多项是/否风险维度一并落盘，便于训练奖励模型、红队评测与上线前质检。"
...
params:
  seo:
      title: "聊天机器人模型评估 (Chatbot Assessment)"
      description: "聊天机器人模型评估模版，左侧多轮对话、右侧多维量表与合规项评测，适配对话质量、安全性与对齐类人工评估。"
      keywords: ["标注模板", "聊天机器人", "模型评估", "RLHF", "生成式 AI", "安全评测"]
      canonical: "https://docs.jujidata.com/docs/templates/generative-ai/chatbot-assessment"
      robots: "index, follow"
---
