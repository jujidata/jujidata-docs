...
params:
  seo:
      ...
      canonical: "https://docs.jujidata.com/docs/templates/object-detection-with-bounding-boxes"
      robots: "index, follow"
---

# 目标检测使用说明

基于矩形框的目标检测，核心是在图像上为每个目标绘制矩形边界框，并赋予对应类别标签，输出「位置 + 类别」的检测标注。区别于语义分割的像素级覆盖，适用于只需定位与分类的场景，例如细胞、车辆、行人、缺陷点等，广泛应用于显微影像、自动驾驶、工业质检、遥感解译等领域。
